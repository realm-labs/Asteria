...
Asteria 是一个模块化的 Kotlin 游戏服务器运行时。它提供应用模块、角色、实体、消息和事件分发、Pekko
集群适配、协议注册、网关会话、持久化契约、配置、脚本、GM
...
- [模块地图](docs/src/zh/module-map.md)
- [应用生命周期](docs/src/zh/application-lifecycle.md)
- [事件系统](docs/src/zh/events.md)
- [配置系统](docs/src/zh/config.md)
- [Pekko 集群](docs/src/zh/cluster-pekko.md)
- [消息、协议和网关](docs/src/zh/messaging-protocol-gateway.md)
- [持久化](docs/src/zh/persistence.md)
- [脚本和 GM](docs/src/zh/script-and-gm.md)
- [运行时补丁](docs/src/zh/patch.md)
- [观测和启动器](docs/src/zh/observability-and-starter.md)

## 示例项目

- [Antares](https://github.com/mikai233/antares)：一个真实游戏服务器脚手架，展示基于 Asteria
  的服务如何组织网关、世界、玩家、GM、配置、协议和工具模块。
