...
Asteria 是一个模块化的 Kotlin 游戏服务器运行时。它提供应用模块、角色、实体、消息和事件分发、Pekko 集群适配、协议注册、网关会话、持久化契约、配置、脚本、GM
...
- [Antares](https://github.com/mikai233/antares)：一个真实游戏服务器脚手架，展示基于 Asteria 的服务如何组织网关、世界、玩家、GM、配置、协议和工具模块。
