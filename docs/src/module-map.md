...
| `foundation-message`                                                       | Message contracts, handlers, and dispatch                                             | The project wants framework-level message dispatch or generated registration                 |
...
| `gateway-core`                                                                            | Gateway transport, session, route registry, and dispatch abstractions | The service accepts client connections                       |
