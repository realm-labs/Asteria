...
class AsteriaConfigCodegenPlugin : Plugin<Project> {
    ...
    private fun addAsteriaDependencies(project: Project, version: String) {
        project.dependencies.addIfConfigurationExists(
            project,
            "implementation",
            project.localProjectOrCoordinate(":asteria-config", "asteria-config", version),
        )
        project.dependencies.addIfConfigurationExists(
            project,
            "implementation",
            project.localProjectOrCoordinate(":asteria-config-annotations", "asteria-config-annotations", version),
        )
        project.dependencies.add(
            "ksp",
            project.localProjectOrCoordinate(":asteria-config-ksp", "asteria-config-ksp", version),
        )
    }
    ...
    companion object {
        ...
        private const val ASTERIA_GROUP = "io.github.mikai233"
