...
class AsteriaProtobufProtocolCodegenPlugin : Plugin<Project> {
    ...
    private fun addAsteriaDependencies(project: Project, version: String) {
        project.dependencies.addIfConfigurationExists(
            project,
            "implementation",
            project.localProjectOrCoordinate(":asteria-protocol-protobuf", "asteria-protocol-protobuf", version),
        )
        project.dependencies.addIfConfigurationExists(
            project,
            "implementation",
            project.localProjectOrCoordinate(":asteria-rpc-protobuf", "asteria-rpc-protobuf", version),
        )
    }
